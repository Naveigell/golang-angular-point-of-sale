...
type Product struct {
	...
	Stock 			uint64				`json:"stock" bson:"stock" name:"Stock" validate:"gte=1,max=62000"`
	MinimumStock 	uint64				`json:"minimum_stock" bson:"minimum_stock" name:"Minimum stock" validate:"gte=1,max=1000"`
	SellingPrice 	uint64				`json:"selling_price" bson:"selling_price" name:"Selling price" validate:"gte=1"`
	PurchasePrice 	uint64				`json:"purchase_price" bson:"purchase_price" name:"Purchase price" validate:"gte=1"`
